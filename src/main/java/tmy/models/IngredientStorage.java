...
public final class IngredientStorage {
    ...
    /**
     * Gets the needed ingredient from the boxes and reduces its amount. If the
     * ingredient doesn't exist, returns nothing.
     * 
     * @param ingredientId id of the needed ingredient.
     * @return the ingredient if it is found in the boxes, nothing if it's not
     *         there.
     */
    ...
    /**
     * Adds the ingredient to the storage. If the type of the ingredient is already
     * there, adds its amount. If not,
